...
import { 
  ...
  Zap, Trophy, Star, Sparkles, AlertTriangle, Gift, AlertCircle, ArrowLeft, Heart, Send
} from 'lucide-react';
...
export default function TelegramScratchApp() {
  ...
  return (
    <div className="min-h-[100dvh] w-full bg-[#0a0a0a] flex justify-center items-center font-sans overflow-hidden relative">
      ...
      {/* Container Principal (No celular ocupa tudo, no PC fica arredondado sem estragar o meio) */}
      <div className="relative w-full h-[100dvh] md:h-[90dvh] max-w-[430px] bg-black flex flex-col md:rounded-[2.5rem] md:border border-white/10 shadow-[0_0_50px_rgba(0,0,0,0.8)] overflow-hidden z-10">
        ...
        {/* A rolagem fica APENAS AQUI DENTRO, protegendo o layout original da sua raspadinha */}
      ...
      {/* 🔥 MODAL DE PERFIL IDÊNTICO AO SEU CÓDIGO 🔥 */}
      {showProfile && player && (
