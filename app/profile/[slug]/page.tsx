  ...
  return (
    <div className="min-h-screen bg-[#050505] text-white font-sans pb-24 relative">
      ...
      <div className="relative w-full h-[55vh] overflow-hidden">
        ...
        {/* BOTÕES DO TOPO (Vitrine + Meu Perfil) */}
        <div className="absolute top-8 left-8 flex flex-wrap gap-4 z-50">
            ...
            <button onClick={() => router.push('/vitrine')} className="px-6 py-3 bg-white/5 backdrop-blur-xl rounded-full border border-white/10 text-white text-[10px] font-black uppercase flex items-center gap-2">
                <LayoutGrid size={16}/> Vitrine
            </button>
            {/* O BOTÃO MEU PERFIL AQUI */}
            <button 
                onClick={() => { if(!isLoggedIn) return setShowAuth(true); router.push('/hub'); }} 
                className="px-6 py-3 bg-[#D946EF]/20 backdrop-blur-xl rounded-full border border-[#D946EF]/50 text-[#D946EF] text-[10px] font-black uppercase flex items-center gap-2 hover:bg-[#D946EF] hover:text-white transition-all shadow-[0_0_15px_rgba(217,70,239,0.3)]"
            >
                <User size={16}/> Meu Perfil
            </button>
        </div>

        {/* FOTO E INFORMAÇÕES DA MUSA (Layout Original Intacto) */}
