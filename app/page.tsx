...
export default function HomePage() {
  ...
  return (
    <div className="min-h-screen bg-black text-white relative font-sans overflow-x-hidden selection:bg-[#FF1493] selection:text-white">
      ...
      {/* SESSÃO 1: BEM-VINDO E BOTÕES (Ocupa 100% da primeira tela) */}
      ...
      {/* SESSÃO 2: QUEM SOMOS (Abaixo da dobra) */}
      <div className="relative z-10 w-full max-w-md mx-auto px-6 pb-24 pt-10 flex flex-col items-center text-center space-y-8">
        ...
        <div className="w-full bg-black/40 border border-[#FF1493]/20 p-8 rounded-[2.5rem] text-left shadow-2xl backdrop-blur-md">
          ...
          <p className="text-white/70 text-[12px] leading-relaxed font-medium">
            Sabe aquela safadeza e intimidade que você sempre teve com a Rapha e com nossas parceiras? Ela continua aqui, mas agora com muito mais adrenalina! A Labz Sexy Roll foi criada para te colocar mais perto das suas modelos favoritas através de um jogo viciante. É o melhor custo-benefício do mercado: com apenas alguns créditos, você gira a roleta e garante conteúdos exclusivos, mimos, fotos e vídeos quentíssimos. Você investe pouco, a sorte gira, e a diversão é sempre garantida!
          </p>
        </div>
        ...
        <div className="w-full bg-black/40 border border-[#FFD700]/20 p-8 rounded-[2.5rem] text-left shadow-2xl backdrop-blur-md">
          ...
          <p className="text-white/70 text-[12px] leading-relaxed font-medium">
            Idealizada por <strong className="text-white font-black">Rapha Savanah (Savanah Cos)</strong>, a Savanah Labz nasceu de uma vivência real: a necessidade de ferramentas inovadoras que realmente valorizem o nosso trabalho. Nós sabemos o quanto você se dedica, por isso criamos uma plataforma onde você é vista exatamente como merece ser vista: como a dona do seu próprio império. A Roleta Sexy é uma novidade explosiva para engajar seu público, multiplicar seus ganhos e ditar as suas próprias regras. Afinal, somos de criadora de conteúdos para criadoras de conteúdos.
          </p>
        </div>
