...
export default function ModelProfile() {
  ...
  const openCheckout = async (type: 'photo' | 'video', price: number, itemInfo: any) => {
    ...
    try {
        ...
        if (type === 'video') {
            ...
            const resReq = await fetch(`${supabaseUrl}/rest/v1/VideoRequests`, { method: 'POST', headers, body: JSON.stringify({ model_id: model.id, player_id: playerId, description: itemInfo.description, duration: itemInfo.duration, price: price, status: 'pendente' }) });
  ...
  return (
    <div className="min-h-screen bg-[#050505] text-white font-sans pb-24 relative">
      ...
      {/* BOTÃO FLUTUANTE UNIVERSAL: MEU PERFIL */}
      <button 
