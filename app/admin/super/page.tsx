...
export default function SuperAdmin() {
  ...
  const fetchData = async () => {
    try {
      ...
      // 🔥 BUSCA SEM FILTROS DE STATUS NA URL PARA GARANTIR QUE PUXE TUDO
      ...
      // 🔥 FILTRO SEGURO: Aceita "Pendente", "pendente" ou até se estiver sem status
      if (resApp.ok) {
      ...
      if (resAbandon.ok) {
        ...
        setAbandoned(carts.filter((c: any) => !c.status || c.status.toLowerCase() === 'pendente'));
      }
