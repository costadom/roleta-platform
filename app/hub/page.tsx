...
export default function PlayerPersonalHub() {
  ...
  useEffect(() => {
    async function loadData() {
      ...
      } catch (e) { console.error("Erro Crítico:", e); } finally { setInitialLoading(false); }
    }
    loadData();
  }, [router]);
  ...
  if (initialLoading) return (
    <div className="min-h-screen bg-black flex flex-col items-center justify-center text-white p-6 text-center">
      ...
      <h2 className="text-xl font-black uppercase italic tracking-tighter animate-pulse">Acessando Universo Privado...</h2>
    </div>
  );
